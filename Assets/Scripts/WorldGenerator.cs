...
public class WorldGenerator : MonoBehaviour {
    ...
    void Start () {
        ...
        world.OnGoalComplete += () =>
        {
            ...
            world.Reset();
            Treasure = Instantiate(WumpusPrefabs["Treasure"], new Vector3(GoldPosition.X, YPosition- 0.2f, GoldPosition.Y), Quaternion.Euler(-90f, 180f, 0));
            iterations++;
    ...
    void CreateWorldPlatform()
    {
        for (int i = 0; i < world.WorldHeight; i++)
        {
            for (int j = 0; j < world.WorldWidth; j++)
            {
                ...
                if (world.GoldAt(pos))
                    Treasure = Instantiate(WumpusPrefabs["Treasure"], new Vector3(i, YPosition - 0.2f, j), Quaternion.Euler(-90f, 180f, 0));
                    ...
                    Instantiate(WumpusPrefabs["Wumpus"], new Vector3(i, YPosition +0.2f, j), Quaternion.Euler(0, 0, 0));
            }
        }
    }
}
